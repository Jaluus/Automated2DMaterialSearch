...
class TIS_CAM(object):
    ...
    def GetVideoFormats(self):
        ...
        for i in range(iVideoFormats):
            self._Properties.append(
                TIS_GrabberDLL.GetVideoFormat(self._handle, i))
    ...
    def GetInputChannels(self):
        ...
        for i in range(InputChannelscount):
            self.InputChannels.append(
                TIS_GrabberDLL.GetInputChannel(self._handle, i))
    ...
    def GetVideoNormCount(self):
        ...
        for i in range(GetVideoNorm_Count):
            self.GetVideoNorm.append(
                TIS_GrabberDLL.GetVideoNorm(self._handle, i))
    ...
    def GetCameraProperty(self, iProperty):
        lFocusPos = C.c_long()
        Error = TIS_GrabberDLL.GetCameraProperty(
            self._handle, iProperty, lFocusPos)
        return (lFocusPos.value)

    def SetCameraProperty(self, iProperty, iValue):
        Error = TIS_GrabberDLL.SetCameraProperty(
            self._handle, iProperty, iValue)
        return (Error)
