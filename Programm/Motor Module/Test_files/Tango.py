...
if error > 0:
    ...
    print("acceleration = " + str(dx.value) + " " +
          str(dy.value) + " " + str(dz.value) + " " + str(da.value))
...
if error > 0:
    ...
    print("pitch = " + str(dx.value) + " " + str(dy.value) +
          " " + str(dz.value) + " " + str(da.value))
...
if error > 0:
    ...
    print("gear = " + str(dx.value) + " " + str(dy.value) +
          " " + str(dz.value) + " " + str(da.value))


# query motor current (in A)
error = m_Tango.LSX_GetMotorCurrent(
    LSID, byref(dx), byref(dy), byref(dz), byref(da))
if error > 0:
    print("Error: GetMotorCurrent " + str(error))
else:
    print("motor current = " + str(dx.value) + " " +
          str(dy.value) + " " + str(dz.value) + " " + str(da.value))
