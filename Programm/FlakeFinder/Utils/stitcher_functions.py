...
def compress_images(
    ...
    image_names = os.listdir(picture_directory)
    ...
    img = cv2.imread(os.path.join(picture_directory, image_names[0]))
    height = img.shape[1]
    width = img.shape[0]
    ...
    for idx, image_name in enumerate(image_names):
        ...
        single_img_path = os.path.join(picture_directory, image_name)
